 ...
 * @Desc：
 * 1. 先连接zk
 * 2. 执行registerForMaster方法，并注册watch事件监控/master节点
 * 3. 发现/master节点未创建，线程竞争创建/master节点，创建失败的线程继续执行registerForMaster方法，注册监控事件
 * 4. /master节点失效后，剩下的线程被唤醒，开始执行创建/master节点的操作
 */
